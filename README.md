...
A Demo App Which is made using Dart,Flutter And Firebase.
...
- Just A Demo App Using Firebase 🔥
...
2) Run The Following Commands :
```git
$ git clone https://github.com/dakshp07/flutter-firebase-demo-app.git
```

## Images

![First](images/Screenshot_1599231634.png)
